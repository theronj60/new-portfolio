...
<template>
	<nav class="test fixed h-16 bg-gray-800 opacity-75 min-w-screen w-full text-gray-100 px-4 flex justify-between items-center">
	    <img src="/imgs/mnts.png" class="h-12 w-12 ml-auto md:ml-12" alt="page-logo"/>
